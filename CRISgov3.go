...
func main() {
    ...
    if len(os.Args) < 7 {
        ...
        fmt.Println("It processes 'xxxx_R1_001.fastq' files first. Then use the reverse complements of your input sequences to search 'xxxx_R2_001.fastq' files")
    ...
    matchesR1, _ := filepath.Glob("*_R1_*.fastq")
    matchesR2, _ := filepath.Glob("*_R2_*.fastq")
